...
MODULES_DIR="$BASE_DIR/aleo_pantest/core/modules"
LOG_FILE="$BASE_DIR/aleo_pantest/core/logs/module_update.log"
...
# aws s3 cp "$BACKUP_FILE" s3://aleo-pantest-backups/modules/
