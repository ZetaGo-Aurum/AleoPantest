...
from aleopantest.modules.network.ddos_simulator import DDoSSimulator
...
class TestDDoSSimulator(unittest.TestCase):
    ...
    @patch('aleopantest.modules.network.ddos_simulator.send')
    @patch('aleopantest.modules.network.ddos_simulator.HAS_SCAPY', True)
    def test_syn_flood(self, mock_send):
        # Mock Scapy classes
        with patch('aleopantest.modules.network.ddos_simulator.IP'), \
             patch('aleopantest.modules.network.ddos_simulator.TCP'):
    ...
    def test_udp_flood(self, mock_send):
        with patch('aleopantest.modules.network.ddos_simulator.IP'), \
             patch('aleopantest.modules.network.ddos_simulator.UDP'), \
             patch('aleopantest.modules.network.ddos_simulator.Raw'):
    ...
    def test_dns_flood(self, mock_send):
        with patch('aleopantest.modules.network.ddos_simulator.IP'), \
             patch('aleopantest.modules.network.ddos_simulator.UDP'), \
             patch('aleopantest.modules.network.ddos_simulator.DNS'), \
             patch('aleopantest.modules.network.ddos_simulator.DNSQR'):
