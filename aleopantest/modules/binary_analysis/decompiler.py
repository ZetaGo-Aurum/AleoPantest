"""
Decompiler Tool - Aleopantest V4.0.0
...
class Decompiler(BaseTool):
    """Decompile binary to pseudo-code"""

    def __init__(self):
        metadata = ToolMetadata(
            name="Decompiler Tool",
            category=ToolCategory.BINARY,
            version="4.0.0",
            author="Aleocrophic Team",
            description="Decompile binary to pseudo-code",
            usage="aleopantest run decompiler --target <target>",
            requirements=[],
            tags=['binary', 'decompile', 'code'],
            risk_level="LOW",
