"""
Fuzzer Generator - Aleopantest V4.0.0

Generate fuzzing inputs for binaries
"""
import time
import datetime
...
class FuzzerGen(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Generate fuzzing inputs for binaries",
            usage="aleopantest run fuzzer-gen --target <target>",
            requirements=[],
            tags=['binary', 'fuzz', 'gen'],
            risk_level="LOW",
