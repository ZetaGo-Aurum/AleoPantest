"""
Shellcode Generator - Aleopantest V4.0.0
...
class ShellcodeGen(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Generate shellcode payloads",
            usage="aleopantest run shellcode-gen --target <target>",
            requirements=[],
            tags=['binary', 'shellcode', 'gen'],
            risk_level="CRITICAL",
