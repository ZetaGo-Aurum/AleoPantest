"""
Binary String Extractor - Aleopantest V4.0.0
...
class BinaryStrings(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            usage="aleopantest run binary-strings --target <target>",
            requirements=[],
            tags=['binary', 'strings', 'extract'],
            risk_level="LOW",
    ...
    def run(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            result = {
                ...
                "summary": {
                    "risk_level": "LOW",
                    "scan_type": "Binary String Extractor",
