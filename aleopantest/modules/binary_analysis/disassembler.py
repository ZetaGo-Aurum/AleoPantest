"""
Disassembler Tool - Aleopantest V4.0.0

Disassemble binary to assembly code
"""
import time
import datetime
...
class Disassembler(BaseTool):
    """Disassemble binary to assembly code"""

    def __init__(self):
        metadata = ToolMetadata(
            name="Disassembler Tool",
            category=ToolCategory.BINARY,
            version="4.0.0",
            author="Aleocrophic Team",
            description="Disassemble binary to assembly code",
            usage="aleopantest run disassembler --target <target>",
            requirements=[],
            tags=['binary', 'disasm', 'assembly'],
            risk_level="LOW",
