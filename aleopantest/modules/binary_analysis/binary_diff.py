"""
Binary Differ - Aleopantest V4.0.0

Compare binary files for differences
"""
import time
import datetime
...
class BinaryDiff(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Compare binary files for differences",
            usage="aleopantest run binary-diff --target <target>",
            requirements=[],
            tags=['binary', 'diff', 'compare'],
            risk_level="LOW",
