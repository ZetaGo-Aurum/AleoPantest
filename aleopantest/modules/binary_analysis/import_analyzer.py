"""
Import Analyzer - Aleopantest V4.0.0
...
class ImportAnalyzer(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Analyze binary imports and dependencies",
            usage="aleopantest run import-analyzer --target <target>",
            requirements=[],
            tags=['binary', 'import', 'analyze'],
            risk_level="LOW",
