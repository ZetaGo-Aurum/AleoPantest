"""
Symbol Extractor - Aleopantest V4.0.0

Extract symbols from binaries
"""
import time
import datetime
...
class SymbolExtract(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Extract symbols from binaries",
            usage="aleopantest run symbol-extract --target <target>",
            requirements=[],
            tags=['binary', 'symbol', 'extract'],
            risk_level="LOW",
