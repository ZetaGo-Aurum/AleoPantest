"""
VTable Analyzer - Aleopantest V4.0.0
...
class VTableAnalyzer(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Analyze C++ virtual function tables",
            usage="aleopantest run vtable-analyzer --target <target>",
            requirements=[],
            tags=['binary', 'vtable', 'cpp'],
            risk_level="LOW",
