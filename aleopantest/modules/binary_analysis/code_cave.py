"""
Code Cave Finder - Aleopantest V4.0.0

Find code caves in binaries
"""
import time
import datetime
...
class CodeCave(BaseTool):
    """Find code caves in binaries"""

    def __init__(self):
        metadata = ToolMetadata(
            name="Code Cave Finder",
            category=ToolCategory.BINARY,
            version="4.0.0",
            author="Aleocrophic Team",
            description="Find code caves in binaries",
            usage="aleopantest run code-cave --target <target>",
            requirements=[],
            tags=['binary', 'cave', 'find'],
            risk_level="LOW",
