"""
SSO Auditor - Aleopantest V4.0.0

Audit Single Sign-On implementations
"""
import time
import datetime
...
class SSOAudit(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Audit Single Sign-On implementations",
            usage="aleopantest run sso-audit --target <target>",
            requirements=[],
            tags=['auth', 'sso', 'audit'],
            risk_level="LOW",
