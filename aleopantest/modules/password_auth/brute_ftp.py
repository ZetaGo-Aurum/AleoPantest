"""
FTP Brute Forcer - Aleopantest V4.0.0
...
class BruteFTP(BaseTool):
    """Brute force FTP authentication"""

    def __init__(self):
        metadata = ToolMetadata(
            name="FTP Brute Forcer",
            category=ToolCategory.PASSWORD,
            version="4.0.0",
            author="Aleocrophic Team",
            description="Brute force FTP authentication",
            usage="aleopantest run brute-ftp --target <target>",
            requirements=[],
            tags=['brute', 'ftp', 'auth'],
            risk_level="HIGH",
