"""
MySQL Brute Forcer - Aleopantest V4.0.0
...
class BruteMySQL(BaseTool):
    """Brute force MySQL authentication"""

    def __init__(self):
        metadata = ToolMetadata(
            name="MySQL Brute Forcer",
            category=ToolCategory.PASSWORD,
            version="4.0.0",
            author="Aleocrophic Team",
            description="Brute force MySQL authentication",
            usage="aleopantest run brute-mysql --target <target>",
            requirements=[],
            tags=['brute', 'mysql', 'auth'],
            risk_level="HIGH",
