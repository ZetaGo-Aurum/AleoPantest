"""
Credential Tester - Aleopantest V4.0.0
...
class CredentialTest(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Test credentials against services",
            usage="aleopantest run credential-test --target <target>",
            requirements=[],
            tags=['password', 'credential', 'test'],
            risk_level="HIGH",
