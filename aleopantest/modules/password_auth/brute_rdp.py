"""
RDP Brute Forcer - Aleopantest V4.0.0
...
class BruteRDP(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Brute force RDP authentication",
            usage="aleopantest run brute-rdp --target <target>",
            requirements=[],
            tags=['brute', 'rdp', 'auth'],
            risk_level="HIGH",
