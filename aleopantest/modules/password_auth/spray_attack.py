"""
Password Spraying - Aleopantest V4.0.0

Password spraying attack tool
"""
import time
import datetime
...
class SprayAttack(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Password spraying attack tool",
            usage="aleopantest run spray-attack --target <target>",
            requirements=[],
            tags=['password', 'spray', 'attack'],
            risk_level="HIGH",
