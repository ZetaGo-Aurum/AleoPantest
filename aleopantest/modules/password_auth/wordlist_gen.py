"""
Wordlist Generator - Aleopantest V4.0.0
...
class WordlistGen(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            usage="aleopantest run wordlist-gen --target <target>",
            requirements=[],
            tags=['password', 'wordlist', 'gen'],
            risk_level="LOW",
