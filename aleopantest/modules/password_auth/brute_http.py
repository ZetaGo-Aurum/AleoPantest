"""
HTTP Brute Forcer - Aleopantest V4.0.0
...
class BruteHTTP(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Brute force HTTP authentication",
            usage="aleopantest run brute-http --target <target>",
            requirements=[],
            tags=['brute', 'http', 'auth'],
            risk_level="HIGH",
