"""
Default Credentials Checker - Aleopantest V4.0.0
...
class DefaultCreds(BaseTool):
    """Check for default credentials"""

    def __init__(self):
        metadata = ToolMetadata(
            name="Default Credentials Checker",
            category=ToolCategory.PASSWORD,
            version="4.0.0",
            author="Aleocrophic Team",
            description="Check for default credentials",
            usage="aleopantest run default-creds --target <target>",
            requirements=[],
            tags=['password', 'default', 'creds'],
            risk_level="LOW",
    ...
    def run(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            result = {
                ...
                "summary": {
                    "risk_level": "LOW",
                    "scan_type": "Default Credentials Checker",
