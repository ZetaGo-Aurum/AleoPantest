"""
Cookie Analyzer - Aleopantest V4.0.0
...
class CookieAnalyzer(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Analyze cookie security properties",
            usage="aleopantest run cookie-analyzer --target <target>",
            requirements=[],
            tags=['auth', 'cookie', 'analyze'],
            risk_level="LOW",
