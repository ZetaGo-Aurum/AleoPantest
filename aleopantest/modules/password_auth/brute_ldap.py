"""
LDAP Brute Forcer - Aleopantest V4.0.0
...
class BruteLDAP(BaseTool):
    """Brute force LDAP authentication"""

    def __init__(self):
        metadata = ToolMetadata(
            name="LDAP Brute Forcer",
            category=ToolCategory.PASSWORD,
            version="4.0.0",
            author="Aleocrophic Team",
            description="Brute force LDAP authentication",
            usage="aleopantest run brute-ldap --target <target>",
            requirements=[],
            tags=['brute', 'ldap', 'auth'],
            risk_level="HIGH",
