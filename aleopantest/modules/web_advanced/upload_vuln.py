"""
File Upload Vulnerability - Aleopantest V4.0.0
...
class UploadVuln(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            usage="aleopantest run upload-vuln --target <target>",
            requirements=[],
            tags=['web', 'upload', 'file'],
            risk_level="HIGH",
    ...
    def run(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            result = {
                ...
                "summary": {
                    "risk_level": "HIGH",
                    "scan_type": "File Upload Vulnerability",
