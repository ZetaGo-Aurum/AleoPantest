"""
Parameter Miner - Aleopantest V4.0.0

Discover hidden web parameters
"""
import time
import datetime
...
class WebParamMine(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Discover hidden web parameters",
            usage="aleopantest run web-param-mine --target <target>",
            requirements=[],
            tags=['web', 'param', 'mine'],
            risk_level="LOW",
