"""
Command Injection Detector - Aleopantest V4.0.0
...
class CommandInject(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            usage="aleopantest run command-inject --target <target>",
            requirements=[],
            tags=['web', 'command', 'inject'],
            risk_level="CRITICAL",
    ...
    def run(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            result = {
                ...
                "summary": {
                    "risk_level": "CRITICAL",
                    "scan_type": "Command Injection Detector",
