"""
GraphQL Vulnerability Scanner - Aleopantest V4.0.0
...
class GraphQLVuln(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            usage="aleopantest run graphql-vuln --target <target>",
            requirements=[],
            tags=['web', 'graphql', 'vuln'],
            risk_level="LOW",
    ...
    def run(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            result = {
                ...
                "summary": {
                    "risk_level": "LOW",
                    "scan_type": "GraphQL Vulnerability Scanner",
