"""
Host Header Injection - Aleopantest V4.0.0
...
class HostHeaderInject(BaseTool):
    """Test for host header injection"""
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            usage="aleopantest run host-header-inject --target <target>",
            requirements=[],
            tags=['web', 'host', 'header'],
            risk_level="LOW",
    ...
    def run(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            result = {
                ...
                "summary": {
                    "risk_level": "LOW",
                    "scan_type": "Host Header Injection",
