"""
Open Redirect Finder - Aleopantest V4.0.0
...
class OpenRedirect(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            usage="aleopantest run open-redirect --target <target>",
            requirements=[],
            tags=['web', 'redirect', 'open'],
            risk_level="LOW",
    ...
    def run(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            result = {
                ...
                "summary": {
                    "risk_level": "LOW",
                    "scan_type": "Open Redirect Finder",
