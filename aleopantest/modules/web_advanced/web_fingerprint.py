"""
Web Fingerprinter - Aleopantest V4.0.0
...
class WebFingerprint(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Fingerprint web technologies and versions",
            usage="aleopantest run web-fingerprint --target <target>",
            requirements=[],
