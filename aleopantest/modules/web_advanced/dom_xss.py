"""
DOM XSS Scanner - Aleopantest V4.0.0
...
class DOMXSS(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Scan for DOM-based XSS vulnerabilities",
            usage="aleopantest run dom-xss --target <target>",
            requirements=[],
            tags=['web', 'dom', 'xss'],
            risk_level="HIGH",
