"""
CSP Analyzer - Aleopantest V4.0.0
...
class ContentSecurity(BaseTool):
    """Analyze Content Security Policy headers"""
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            usage="aleopantest run content-security --target <target>",
            requirements=[],
            tags=['web', 'csp', 'headers'],
            risk_level="LOW",
