"""
WAF Bypass Tester - Aleopantest V4.0.0
...
class WAFBypass(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Test WAF bypass techniques",
            usage="aleopantest run waf-bypass --target <target>",
            requirements=[],
            tags=['web', 'waf', 'bypass'],
            risk_level="HIGH",
