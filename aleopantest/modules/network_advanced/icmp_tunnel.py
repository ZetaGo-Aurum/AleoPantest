"""
ICMP Tunnel Detector - Aleopantest V4.0.0
...
class ICMPTunnel(BaseTool):
    """Detect ICMP tunneling"""

    def __init__(self):
        metadata = ToolMetadata(
            name="ICMP Tunnel Detector",
            category=ToolCategory.NETWORK_ADVANCED,
            version="4.0.0",
            author="Aleocrophic Team",
            description="Detect ICMP tunneling",
            usage="aleopantest run icmp-tunnel --target <target>",
            requirements=[],
            tags=['network', 'icmp', 'tunnel'],
            risk_level="LOW",
    ...
    def run(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            result = {
                ...
                "summary": {
                    "risk_level": "LOW",
                    "scan_type": "ICMP Tunnel Detector",
