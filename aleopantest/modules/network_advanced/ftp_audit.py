"""
FTP Auditor - Aleopantest V4.0.0

Audit FTP server security
"""
import time
import datetime
...
class FTPAudit(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Audit FTP server security",
            usage="aleopantest run ftp-audit --target <target>",
            requirements=[],
            tags=['network', 'ftp', 'audit'],
            risk_level="LOW",
