"""
SSDP Scanner - Aleopantest V4.0.0

Scan for SSDP/UPnP services
"""
import time
import datetime
...
class SSDPScan(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Scan for SSDP/UPnP services",
            usage="aleopantest run ssdp-scan --target <target>",
            requirements=[],
            tags=['network', 'ssdp', 'upnp'],
            risk_level="LOW",
