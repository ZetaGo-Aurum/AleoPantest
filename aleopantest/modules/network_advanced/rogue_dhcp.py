"""
Rogue DHCP Detector - Aleopantest V4.0.0
...
class RogueDHCP(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Detect rogue DHCP servers",
            usage="aleopantest run rogue-dhcp --target <target>",
            requirements=[],
            tags=['network', 'dhcp', 'rogue'],
            risk_level="LOW",
