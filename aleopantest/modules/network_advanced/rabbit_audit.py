"""
RabbitMQ Auditor - Aleopantest V4.0.0

Audit RabbitMQ server security
"""
import time
import datetime
...
class RabbitAudit(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Audit RabbitMQ server security",
            usage="aleopantest run rabbit-audit --target <target>",
            requirements=[],
            tags=['network', 'rabbitmq', 'audit'],
            risk_level="LOW",
