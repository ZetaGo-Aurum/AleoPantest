"""
Telnet Auditor - Aleopantest V4.0.0

Audit Telnet server security
"""
import time
import datetime
...
class TelnetAudit(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Audit Telnet server security",
            usage="aleopantest run telnet-audit --target <target>",
            requirements=[],
            tags=['network', 'telnet', 'audit'],
            risk_level="LOW",
