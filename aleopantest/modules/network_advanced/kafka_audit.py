"""
Kafka Auditor - Aleopantest V4.0.0

Audit Apache Kafka security
"""
import time
import datetime
...
class KafkaAudit(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Audit Apache Kafka security",
            usage="aleopantest run kafka-audit --target <target>",
            requirements=[],
            tags=['network', 'kafka', 'audit'],
            risk_level="LOW",
