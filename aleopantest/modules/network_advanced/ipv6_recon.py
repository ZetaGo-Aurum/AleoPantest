"""
IPv6 Reconnaissance - Aleopantest V4.0.0

IPv6 network reconnaissance tool
"""
import time
import datetime
...
class IPv6Recon(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="IPv6 network reconnaissance tool",
            usage="aleopantest run ipv6-recon --target <target>",
            requirements=[],
            tags=['network', 'ipv6', 'recon'],
            risk_level="LOW",
