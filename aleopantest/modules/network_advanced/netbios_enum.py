"""
NetBIOS Enumerator - Aleopantest V4.0.0

Enumerate NetBIOS services and shares
"""
import time
import datetime
...
class NetBIOSEnum(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Enumerate NetBIOS services and shares",
            usage="aleopantest run netbios-enum --target <target>",
            requirements=[],
            tags=['network', 'netbios', 'enum'],
            risk_level="LOW",
