"""
NTP Amplification Check - Aleopantest V4.0.0

Check for NTP amplification vectors
"""
import time
import datetime
...
class NTPAmp(BaseTool):
    """Check for NTP amplification vectors"""

    def __init__(self):
        metadata = ToolMetadata(
            name="NTP Amplification Check",
            category=ToolCategory.NETWORK_ADVANCED,
            version="4.0.0",
            author="Aleocrophic Team",
            description="Check for NTP amplification vectors",
            usage="aleopantest run ntp-amp --target <target>",
            requirements=[],
            tags=['network', 'ntp', 'amp'],
            risk_level="LOW",
    ...
    def run(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            result = {
                ...
                "summary": {
                    "risk_level": "LOW",
                    "scan_type": "NTP Amplification Check",
