"""
Redis Auditor - Aleopantest V4.0.0

Audit Redis server security
"""
import time
import datetime
...
class RedisAudit(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Audit Redis server security",
            usage="aleopantest run redis-audit --target <target>",
            requirements=[],
            tags=['network', 'redis', 'audit'],
            risk_level="LOW",
