"""
RDP Auditor - Aleopantest V4.0.0
...
class RDPAudit(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Audit RDP security configuration",
            usage="aleopantest run rdp-audit --target <target>",
            requirements=[],
            tags=['network', 'rdp', 'audit'],
            risk_level="LOW",
