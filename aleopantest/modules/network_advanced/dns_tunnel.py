"""
DNS Tunnel Detector - Aleopantest V4.0.0
...
class DNSTunnel(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            usage="aleopantest run dns-tunnel --target <target>",
            requirements=[],
            tags=['network', 'dns', 'tunnel'],
            risk_level="LOW",
