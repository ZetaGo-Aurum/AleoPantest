"""
IMAP Auditor - Aleopantest V4.0.0

Audit IMAP server security
"""
import time
import datetime
...
class IMAPAudit(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Audit IMAP server security",
            usage="aleopantest run imap-audit --target <target>",
            requirements=[],
            tags=['network', 'imap', 'audit'],
            risk_level="LOW",
