"""
VNC Auditor - Aleopantest V4.0.0

Audit VNC server security
"""
import time
import datetime
...
class VNCAudit(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Audit VNC server security",
            usage="aleopantest run vnc-audit --target <target>",
            requirements=[],
            tags=['network', 'vnc', 'audit'],
            risk_level="LOW",
