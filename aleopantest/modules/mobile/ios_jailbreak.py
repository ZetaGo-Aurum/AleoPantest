"""
iOS Jailbreak Detector - Aleopantest V4.0.0

Detect jailbreak on iOS devices
"""
import time
import datetime
...
class IOSJailbreak(BaseTool):
    """Detect jailbreak on iOS devices"""

    def __init__(self):
        metadata = ToolMetadata(
            name="iOS Jailbreak Detector",
            category=ToolCategory.MOBILE,
            version="4.0.0",
            author="Aleocrophic Team",
            description="Detect jailbreak on iOS devices",
            usage="aleopantest run ios-jailbreak --target <target>",
            requirements=[],
    ...
    def run(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            result = {
                ...
                "summary": {
                    "risk_level": "LOW",
                    "scan_type": "iOS Jailbreak Detector",
