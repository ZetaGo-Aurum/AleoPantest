"""
SOX Auditor - Aleopantest V4.0.0
...
class SOXAudit(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Audit SOX compliance",
            usage="aleopantest run sox-audit --target <target>",
            requirements=[],
