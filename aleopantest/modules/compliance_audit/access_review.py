"""
Access Review Tool - Aleopantest V4.0.0
...
class AccessReview(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            usage="aleopantest run access-review --target <target>",
            requirements=[],
            tags=['compliance', 'access', 'review'],
            risk_level="LOW",
