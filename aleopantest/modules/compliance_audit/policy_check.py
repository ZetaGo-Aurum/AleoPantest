"""
Policy Checker - Aleopantest V4.0.0
...
class PolicyCheck(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            usage="aleopantest run policy-check --target <target>",
            requirements=[],
            tags=['compliance', 'policy', 'check'],
            risk_level="LOW",
