"""
Gap Analysis Tool - Aleopantest V4.0.0
...
class GapAnalysis(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Perform security gap analysis",
            usage="aleopantest run gap-analysis --target <target>",
            requirements=[],
