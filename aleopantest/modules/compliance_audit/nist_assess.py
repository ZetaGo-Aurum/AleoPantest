"""
NIST Assessment - Aleopantest V4.0.0
...
class NISTAssess(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Assess NIST cybersecurity framework",
            usage="aleopantest run nist-assess --target <target>",
            requirements=[],
