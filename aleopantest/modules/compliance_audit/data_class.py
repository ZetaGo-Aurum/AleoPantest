"""
Data Classification - Aleopantest V4.0.0
...
class DataClass(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Classify sensitive data types",
            usage="aleopantest run data-class --target <target>",
            requirements=[],
