"""
Browser Forensics - Aleopantest V4.0.0
...
class BrowserForensics(BaseTool):
    """Extract browser history and artifacts"""
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Extract browser history and artifacts",
            usage="aleopantest run browser-forensics --target <target>",
            requirements=[],
            tags=['forensics', 'browser', 'history'],
            risk_level="LOW",
