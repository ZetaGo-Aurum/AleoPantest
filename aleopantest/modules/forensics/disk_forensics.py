"""
Disk Forensics - Aleopantest V4.0.0
...
class DiskForensics(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            usage="aleopantest run disk-forensics --target <target>",
            requirements=[],
            tags=['forensics', 'disk', 'evidence'],
            risk_level="LOW",
