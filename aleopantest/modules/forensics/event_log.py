"""
Event Log Analyzer - Aleopantest V4.0.0
...
class EventLog(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Analyze Windows/Linux event logs",
            usage="aleopantest run event-log --target <target>",
            requirements=[],
            tags=['forensics', 'eventlog', 'analyze'],
            risk_level="LOW",
