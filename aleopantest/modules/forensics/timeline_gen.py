"""
Timeline Generator - Aleopantest V4.0.0

Generate forensic timeline of events
"""
import time
import datetime
...
class TimelineGen(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Generate forensic timeline of events",
            usage="aleopantest run timeline-gen --target <target>",
            requirements=[],
            tags=['forensics', 'timeline', 'events'],
            risk_level="LOW",
