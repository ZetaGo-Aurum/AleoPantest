"""
Encryption Detector - Aleopantest V4.0.0

Detect encrypted volumes/files
"""
import time
import datetime
...
class EncryptionDetect(BaseTool):
    """Detect encrypted volumes/files"""

    def __init__(self):
        metadata = ToolMetadata(
            name="Encryption Detector",
            category=ToolCategory.FORENSICS,
            version="4.0.0",
            author="Aleocrophic Team",
            description="Detect encrypted volumes/files",
            usage="aleopantest run encryption-detect --target <target>",
            requirements=[],
            tags=['forensics', 'encryption', 'detect'],
            risk_level="LOW",
