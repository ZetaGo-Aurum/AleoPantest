"""
Prefetch Analyzer - Aleopantest V4.0.0
...
class PrefetchAnalyzer(BaseTool):
    """Analyze Windows prefetch files"""
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Analyze Windows prefetch files",
            usage="aleopantest run prefetch-analyzer --target <target>",
            requirements=[],
            tags=['forensics', 'prefetch', 'windows'],
            risk_level="LOW",
