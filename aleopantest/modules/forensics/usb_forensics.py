"""
USB Forensics - Aleopantest V4.0.0

Analyze USB device artifacts
"""
import time
import datetime
...
class USBForensics(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Analyze USB device artifacts",
            usage="aleopantest run usb-forensics --target <target>",
            requirements=[],
            tags=['forensics', 'usb', 'device'],
            risk_level="LOW",
