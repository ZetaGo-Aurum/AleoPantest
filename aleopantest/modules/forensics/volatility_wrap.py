"""
Volatility Wrapper - Aleopantest V4.0.0

Memory forensics via Volatility
"""
import time
import datetime
...
class VolatilityWrap(BaseTool):
    """Memory forensics via Volatility"""

    def __init__(self):
        metadata = ToolMetadata(
            name="Volatility Wrapper",
            category=ToolCategory.FORENSICS,
            version="4.0.0",
            author="Aleocrophic Team",
            description="Memory forensics via Volatility",
            usage="aleopantest run volatility-wrap --target <target>",
            requirements=[],
