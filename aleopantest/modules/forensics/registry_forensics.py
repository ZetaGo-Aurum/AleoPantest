"""
Registry Forensics - Aleopantest V4.0.0
...
class RegistryForensics(BaseTool):
    """Analyze Windows registry hives"""
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            usage="aleopantest run registry-forensics --target <target>",
            requirements=[],
