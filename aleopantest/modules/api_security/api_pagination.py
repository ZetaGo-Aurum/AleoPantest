"""
API Pagination Test - Aleopantest V4.0.0

Test API pagination for data leaks
"""
import time
import datetime
...
class APIPagination(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Test API pagination for data leaks",
            usage="aleopantest run api-pagination --target <target>",
            requirements=[],
            tags=['api', 'pagination', 'test'],
            risk_level="LOW",
