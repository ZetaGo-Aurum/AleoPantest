"""
API Key Leak Scanner - Aleopantest V4.0.0

Scan for exposed API keys in code/responses
"""
import time
import datetime
...
class APIKeyLeak(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Scan for exposed API keys in code/responses",
            usage="aleopantest run api-key-leak --target <target>",
            requirements=[],
            tags=['api', 'key', 'leak'],
            risk_level="LOW",
    ...
    def run(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            result = {
                ...
                "summary": {
                    "risk_level": "LOW",
                    "scan_type": "API Key Leak Scanner",
