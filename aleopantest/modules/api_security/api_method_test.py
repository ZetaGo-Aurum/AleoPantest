"""
API HTTP Method Test - Aleopantest V4.0.0

Test allowed HTTP methods on API endpoints
"""
import time
import datetime
...
class APIMethodTest(BaseTool):
    """Test allowed HTTP methods on API endpoints"""

    def __init__(self):
        metadata = ToolMetadata(
            name="API HTTP Method Test",
            category=ToolCategory.API_SECURITY,
            version="4.0.0",
            author="Aleocrophic Team",
            description="Test allowed HTTP methods on API endpoints",
            usage="aleopantest run api-method-test --target <target>",
            requirements=[],
            tags=['api', 'method', 'test'],
            risk_level="LOW",
    ...
    def run(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            result = {
                ...
                "summary": {
                    "risk_level": "LOW",
                    "scan_type": "API HTTP Method Test",
