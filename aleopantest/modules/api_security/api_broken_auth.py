"""
API Broken Auth Check - Aleopantest V4.0.0
...
class APIBrokenAuth(BaseTool):
    """Check for broken authentication in APIs"""

    def __init__(self):
        metadata = ToolMetadata(
            name="API Broken Auth Check",
            category=ToolCategory.API_SECURITY,
            version="4.0.0",
            author="Aleocrophic Team",
            description="Check for broken authentication in APIs",
            usage="aleopantest run api-broken-auth --target <target>",
            requirements=[],
            tags=['api', 'broken', 'auth'],
            risk_level="LOW",
    ...
    def run(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            result = {
                ...
                "summary": {
                    "risk_level": "LOW",
                    "scan_type": "API Broken Auth Check",
