"""
API Mass Assignment - Aleopantest V4.0.0
...
class APIMassAssign(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            usage="aleopantest run api-mass-assign --target <target>",
            requirements=[],
            tags=['api', 'mass', 'assign'],
            risk_level="LOW",
