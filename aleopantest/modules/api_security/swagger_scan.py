"""
Swagger/OpenAPI Scanner - Aleopantest V4.0.0

Scan OpenAPI/Swagger specs for security issues
"""
import time
import datetime
...
class SwaggerScan(BaseTool):
    """Scan OpenAPI/Swagger specs for security issues"""

    def __init__(self):
        metadata = ToolMetadata(
            name="Swagger/OpenAPI Scanner",
            category=ToolCategory.API_SECURITY,
            version="4.0.0",
            author="Aleocrophic Team",
            description="Scan OpenAPI/Swagger specs for security issues",
            usage="aleopantest run swagger-scan --target <target>",
            requirements=[],
    ...
    def run(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            result = {
                ...
                "summary": {
                    "risk_level": "LOW",
                    "scan_type": "Swagger/OpenAPI Scanner",
