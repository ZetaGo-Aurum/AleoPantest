"""
API Excessive Data Check - Aleopantest V4.0.0

Check for excessive data exposure in APIs
"""
import time
import datetime
...
class APIExcessiveData(BaseTool):
    """Check for excessive data exposure in APIs"""

    def __init__(self):
        metadata = ToolMetadata(
            name="API Excessive Data Check",
            category=ToolCategory.API_SECURITY,
            version="4.0.0",
            author="Aleocrophic Team",
            description="Check for excessive data exposure in APIs",
            usage="aleopantest run api-excessive-data --target <target>",
            requirements=[],
    ...
    def run(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            result = {
                ...
                "summary": {
                    "risk_level": "LOW",
                    "scan_type": "API Excessive Data Check",
