"""
gRPC Tester - Aleopantest V4.0.0
...
class GRPCTest(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Test gRPC services for security issues",
            usage="aleopantest run grpc-test --target <target>",
            requirements=[],
            tags=['api', 'grpc', 'test'],
            risk_level="LOW",
