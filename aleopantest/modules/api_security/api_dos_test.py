"""
API DoS Tester - Aleopantest V4.0.0

Test API resilience against denial of service
"""
import time
import datetime
...
class APIDOSTest(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Test API resilience against denial of service",
            usage="aleopantest run api-dos-test --target <target>",
            requirements=[],
            tags=['api', 'dos', 'test'],
            risk_level="HIGH",
