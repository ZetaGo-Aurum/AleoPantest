"""
JWT Attack Tool - Aleopantest V4.0.0
...
class JWTAttack(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Test JWT implementations for common vulnerabilities",
            usage="aleopantest run jwt-attack --target <target>",
            requirements=[],
            tags=['api', 'jwt', 'attack'],
            risk_level="MEDIUM",
