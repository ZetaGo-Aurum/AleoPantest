"""
GraphQL Introspection - Aleopantest V4.0.0
...
class GraphQLIntrospect(BaseTool):
    """Discover GraphQL schema via introspection"""
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Discover GraphQL schema via introspection",
            usage="aleopantest run graphql-introspect --target <target>",
            requirements=[],
            tags=['api', 'graphql', 'introspect'],
            risk_level="LOW",
    ...
    def run(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            result = {
                ...
                "summary": {
                    "risk_level": "LOW",
                    "scan_type": "GraphQL Introspection",
