"""
API Content-Type Fuzzer - Aleopantest V4.0.0

Fuzz Content-Type headers for bypasses
"""
import time
import datetime
...
class APIContentType(BaseTool):
    """Fuzz Content-Type headers for bypasses"""

    def __init__(self):
        metadata = ToolMetadata(
            name="API Content-Type Fuzzer",
            category=ToolCategory.API_SECURITY,
            version="4.0.0",
            author="Aleocrophic Team",
            description="Fuzz Content-Type headers for bypasses",
            usage="aleopantest run api-content-type --target <target>",
            requirements=[],
            tags=['api', 'content', 'fuzz'],
            risk_level="LOW",
    ...
    def run(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            result = {
                ...
                "summary": {
                    "risk_level": "LOW",
                    "scan_type": "API Content-Type Fuzzer",
