"""
Webhook Security Tester - Aleopantest V4.0.0
...
class WebhookTest(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            usage="aleopantest run webhook-test --target <target>",
            requirements=[],
            tags=['api', 'webhook', 'test'],
            risk_level="LOW",
    ...
    def run(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            result = {
                ...
                "summary": {
                    "risk_level": "LOW",
                    "scan_type": "Webhook Security Tester",
