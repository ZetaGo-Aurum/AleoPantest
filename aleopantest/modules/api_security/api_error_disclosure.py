"""
API Error Disclosure - Aleopantest V4.0.0

Check for sensitive info in API errors
"""
import time
import datetime
...
class APIErrorDisclosure(BaseTool):
    """Check for sensitive info in API errors"""

    def __init__(self):
        metadata = ToolMetadata(
            name="API Error Disclosure",
            category=ToolCategory.API_SECURITY,
            version="4.0.0",
            author="Aleocrophic Team",
            description="Check for sensitive info in API errors",
            usage="aleopantest run api-error-disclosure --target <target>",
            requirements=[],
    ...
    def run(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            result = {
                ...
                "summary": {
                    "risk_level": "LOW",
                    "scan_type": "API Error Disclosure",
