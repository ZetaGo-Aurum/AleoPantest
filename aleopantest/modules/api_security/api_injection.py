"""
API Injection Tester - Aleopantest V4.0.0
...
class APIInjection(BaseTool):
    """Test API for injection vulnerabilities"""

    def __init__(self):
        metadata = ToolMetadata(
            name="API Injection Tester",
            category=ToolCategory.API_SECURITY,
            version="4.0.0",
            author="Aleocrophic Team",
            description="Test API for injection vulnerabilities",
            usage="aleopantest run api-injection --target <target>",
            requirements=[],
            tags=['api', 'injection', 'test'],
            risk_level="HIGH",
    ...
    def run(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            result = {
                ...
                "summary": {
                    "risk_level": "HIGH",
                    "scan_type": "API Injection Tester",
