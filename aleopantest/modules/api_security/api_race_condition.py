"""
API Race Condition - Aleopantest V4.0.0

Test APIs for race condition vulnerabilities
"""
import time
import datetime
...
class APIRaceCondition(BaseTool):
    """Test APIs for race condition vulnerabilities"""

    def __init__(self):
        metadata = ToolMetadata(
            name="API Race Condition",
            category=ToolCategory.API_SECURITY,
            version="4.0.0",
            author="Aleocrophic Team",
            description="Test APIs for race condition vulnerabilities",
            usage="aleopantest run api-race-condition --target <target>",
            requirements=[],
