"""
API SSRF Tester - Aleopantest V4.0.0

Test APIs for Server-Side Request Forgery
"""
import time
import datetime
...
class APISSRF(BaseTool):
    """Test APIs for Server-Side Request Forgery"""

    def __init__(self):
        metadata = ToolMetadata(
            name="API SSRF Tester",
            category=ToolCategory.API_SECURITY,
            version="4.0.0",
            author="Aleocrophic Team",
            description="Test APIs for Server-Side Request Forgery",
            usage="aleopantest run api-ssrf --target <target>",
            requirements=[],
            tags=['api', 'ssrf', 'test'],
            risk_level="HIGH",
