"""
API Auth Bypass - Aleopantest V4.0.0

Test for API authentication bypass vectors
"""
import time
import datetime
...
class APIAuthBypass(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Test for API authentication bypass vectors",
            usage="aleopantest run api-auth-bypass --target <target>",
            requirements=[],
