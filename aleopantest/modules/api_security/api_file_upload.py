"""
API File Upload Test - Aleopantest V4.0.0
...
class APIFileUpload(BaseTool):
    """Test API file upload security"""

    def __init__(self):
        metadata = ToolMetadata(
            name="API File Upload Test",
            category=ToolCategory.API_SECURITY,
            version="4.0.0",
            author="Aleocrophic Team",
            description="Test API file upload security",
            usage="aleopantest run api-file-upload --target <target>",
            requirements=[],
    ...
    def run(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            result = {
                ...
                "summary": {
                    "risk_level": "MEDIUM",
                    "scan_type": "API File Upload Test",
