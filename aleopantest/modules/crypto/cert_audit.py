"""
Certificate Auditor - Aleopantest V4.0.0

Audit TLS/SSL certificates
"""
import time
import datetime
...
class CertAudit(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Audit TLS/SSL certificates",
            usage="aleopantest run cert-audit --target <target>",
            requirements=[],
            tags=['crypto', 'cert', 'audit'],
            risk_level="LOW",
