"""
Key Strength Analyzer - Aleopantest V4.0.0
...
class KeyStrength(BaseTool):
    """Analyze cryptographic key strength"""

    def __init__(self):
        metadata = ToolMetadata(
            name="Key Strength Analyzer",
            category=ToolCategory.CRYPTO,
            version="4.0.0",
            author="Aleocrophic Team",
            description="Analyze cryptographic key strength",
            usage="aleopantest run key-strength --target <target>",
            requirements=[],
            tags=['crypto', 'key', 'strength'],
            risk_level="LOW",
    ...
    def run(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            result = {
                ...
                "summary": {
                    "risk_level": "LOW",
                    "scan_type": "Key Strength Analyzer",
