"""
HMAC Tester - Aleopantest V4.0.0
...
class HMACTest(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Test HMAC implementation security",
            usage="aleopantest run hmac-test --target <target>",
            requirements=[],
            tags=['crypto', 'hmac', 'test'],
            risk_level="LOW",
