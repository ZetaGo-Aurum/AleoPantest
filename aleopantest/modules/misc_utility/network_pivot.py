"""
Network Pivoter - Aleopantest V4.0.0

Network pivoting tool
"""
import time
import datetime
...
class NetworkPivot(BaseTool):
    """Network pivoting tool"""

    def __init__(self):
        metadata = ToolMetadata(
            name="Network Pivoter",
            category=ToolCategory.MISC,
            version="4.0.0",
            author="Aleocrophic Team",
            description="Network pivoting tool",
            usage="aleopantest run network-pivot --target <target>",
            requirements=[],
            tags=['misc', 'pivot', 'network'],
            risk_level="HIGH",
