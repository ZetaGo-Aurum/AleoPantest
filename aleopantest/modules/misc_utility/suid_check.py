"""
SUID Binary Checker - Aleopantest V4.0.0
...
class SUIDCheck(BaseTool):
    """Check for SUID/SGID binaries"""

    def __init__(self):
        metadata = ToolMetadata(
            name="SUID Binary Checker",
            category=ToolCategory.MISC,
            version="4.0.0",
            author="Aleocrophic Team",
            description="Check for SUID/SGID binaries",
            usage="aleopantest run suid-check --target <target>",
            requirements=[],
            tags=['misc', 'suid', 'privesc'],
            risk_level="LOW",
