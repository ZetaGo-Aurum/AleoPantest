"""
Cron Job Auditor - Aleopantest V4.0.0

Audit cron/scheduled tasks
"""
import time
import datetime
...
class CronAudit(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Audit cron/scheduled tasks",
            usage="aleopantest run cron-audit --target <target>",
            requirements=[],
            tags=['misc', 'cron', 'audit'],
            risk_level="LOW",
