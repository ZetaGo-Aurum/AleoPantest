"""
Quick File Server - Aleopantest V4.0.0
...
class FileServer(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Start a quick HTTP file server",
            usage="aleopantest run file-server --target <target>",
            requirements=[],
            tags=['misc', 'file', 'server'],
            risk_level="LOW",
