"""
Webshell Detector - Aleopantest V4.0.0

Detect webshells on servers
"""
import time
import datetime
...
class WebshellDetect(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Detect webshells on servers",
            usage="aleopantest run webshell-detect --target <target>",
            requirements=[],
            tags=['misc', 'webshell', 'detect'],
            risk_level="LOW",
