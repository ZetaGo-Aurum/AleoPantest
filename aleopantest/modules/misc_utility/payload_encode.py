"""
Payload Encoder - Aleopantest V4.0.0
...
class PayloadEncode(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Encode payloads in various formats",
            usage="aleopantest run payload-encode --target <target>",
            requirements=[],
            tags=['misc', 'payload', 'encode'],
            risk_level="MEDIUM",
