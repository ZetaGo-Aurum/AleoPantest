"""
Backdoor Detector - Aleopantest V4.0.0

Detect backdoors in systems
"""
import time
import datetime
...
class BackdoorDetect(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Detect backdoors in systems",
            usage="aleopantest run backdoor-detect --target <target>",
            requirements=[],
            tags=['misc', 'backdoor', 'detect'],
            risk_level="LOW",
