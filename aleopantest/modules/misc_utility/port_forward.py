"""
Port Forwarder - Aleopantest V4.0.0

Forward ports for pivoting
"""
import time
import datetime
...
class PortForward(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Forward ports for pivoting",
            usage="aleopantest run port-forward --target <target>",
            requirements=[],
            tags=['misc', 'port', 'forward'],
            risk_level="LOW",
