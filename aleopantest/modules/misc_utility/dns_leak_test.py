"""
DNS Leak Tester - Aleopantest V4.0.0
...
class DNSLeakTest(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Test for DNS leaks",
            usage="aleopantest run dns-leak-test --target <target>",
            requirements=[],
            tags=['misc', 'dns', 'leak'],
            risk_level="LOW",
