"""
Rootkit Detector - Aleopantest V4.0.0

Detect rootkits on systems
"""
import time
import datetime
...
class RootkitDetect(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Detect rootkits on systems",
            usage="aleopantest run rootkit-detect --target <target>",
            requirements=[],
            tags=['misc', 'rootkit', 'detect'],
            risk_level="LOW",
