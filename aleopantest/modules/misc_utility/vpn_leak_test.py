"""
VPN Leak Tester - Aleopantest V4.0.0

Test for VPN DNS/IP leaks
"""
import time
import datetime
...
class VPNLeakTest(BaseTool):
    """Test for VPN DNS/IP leaks"""

    def __init__(self):
        metadata = ToolMetadata(
            name="VPN Leak Tester",
            category=ToolCategory.MISC,
            version="4.0.0",
            author="Aleocrophic Team",
            description="Test for VPN DNS/IP leaks",
            usage="aleopantest run vpn-leak-test --target <target>",
            requirements=[],
            tags=['misc', 'vpn', 'leak'],
            risk_level="LOW",
