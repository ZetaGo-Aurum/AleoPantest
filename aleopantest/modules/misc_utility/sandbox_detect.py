"""
Sandbox Detector - Aleopantest V4.0.0
...
class SandboxDetect(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Detect sandbox/VM environments",
            usage="aleopantest run sandbox-detect --target <target>",
            requirements=[],
            tags=['misc', 'sandbox', 'detect'],
            risk_level="LOW",
