"""
Drone Detector - Aleopantest V4.0.0

Detect drones via RF signals
"""
import time
import datetime
...
class DroneDetect(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Detect drones via RF signals",
            usage="aleopantest run drone-detect --target <target>",
            requirements=[],
            tags=['wireless', 'drone', 'detect'],
            risk_level="LOW",
