"""
BLE Enumerator - Aleopantest V4.0.0
...
class BLEEnum(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Enumerate Bluetooth Low Energy devices",
            usage="aleopantest run ble-enum --target <target>",
            requirements=[],
            tags=['wireless', 'ble', 'enum'],
            risk_level="LOW",
