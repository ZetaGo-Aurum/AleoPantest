"""
PMKID Capturer - Aleopantest V4.0.0
...
class PMKIDCapture(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            usage="aleopantest run pmkid-capture --target <target>",
            requirements=[],
            tags=['wireless', 'pmkid', 'capture'],
            risk_level="HIGH",
