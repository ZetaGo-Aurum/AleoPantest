"""
Bluetooth Scanner - Aleopantest V4.0.0
...
class BluetoothScan(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            usage="aleopantest run bluetooth-scan --target <target>",
            requirements=[],
            tags=['wireless', 'bluetooth', 'scan'],
            risk_level="LOW",
