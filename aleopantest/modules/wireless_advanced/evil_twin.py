"""
Evil Twin Detector - Aleopantest V4.0.0
...
class EvilTwin(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Detect evil twin access points",
            usage="aleopantest run evil-twin --target <target>",
            requirements=[],
            tags=['wireless', 'evil-twin', 'detect'],
            risk_level="LOW",
