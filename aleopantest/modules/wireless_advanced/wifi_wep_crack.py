"""
WEP Cracker - Aleopantest V4.0.0

Crack WEP encryption (legacy)
"""
import time
import datetime
...
class WifiWEPCrack(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Crack WEP encryption (legacy)",
            usage="aleopantest run wifi-wep-crack --target <target>",
            requirements=[],
            tags=['wireless', 'wep', 'crack'],
            risk_level="HIGH",
