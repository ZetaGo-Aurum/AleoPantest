"""
KRACK Tester - Aleopantest V4.0.0

Test for KRACK WPA2 vulnerability
"""
import time
import datetime
...
class KRACKTest(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Test for KRACK WPA2 vulnerability",
            usage="aleopantest run krack-test --target <target>",
            requirements=[],
            tags=['wireless', 'krack', 'wpa2'],
            risk_level="HIGH",
