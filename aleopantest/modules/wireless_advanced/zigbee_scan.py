"""
Zigbee Scanner - Aleopantest V4.0.0

Scan for Zigbee devices and networks
"""
import time
import datetime
...
class ZigbeeScan(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Scan for Zigbee devices and networks",
            usage="aleopantest run zigbee-scan --target <target>",
            requirements=[],
            tags=['wireless', 'zigbee', 'scan'],
            risk_level="LOW",
