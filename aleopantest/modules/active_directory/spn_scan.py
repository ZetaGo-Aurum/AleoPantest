"""
SPN Scanner - Aleopantest V4.0.0

Scan for Service Principal Names in AD
"""
import time
import datetime
...
class SPNScan(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Scan for Service Principal Names in AD",
            usage="aleopantest run spn-scan --target <target>",
            requirements=[],
            tags=['ad', 'spn', 'scan'],
            risk_level="LOW",
