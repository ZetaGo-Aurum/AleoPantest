"""
AD GPO Auditor - Aleopantest V4.0.0

Audit Group Policy Objects in AD
"""
import time
import datetime
...
class ADGPOAudit(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Audit Group Policy Objects in AD",
            usage="aleopantest run ad-gpo-audit --target <target>",
            requirements=[],
            tags=['ad', 'gpo', 'audit'],
            risk_level="LOW",
