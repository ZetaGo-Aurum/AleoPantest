"""
AD ACL Auditor - Aleopantest V4.0.0

Audit Active Directory ACL permissions
"""
import time
import datetime
...
class ADACLAudit(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Audit Active Directory ACL permissions",
            usage="aleopantest run ad-acl-audit --target <target>",
            requirements=[],
            tags=['ad', 'acl', 'audit'],
            risk_level="LOW",
