"""
GPP Password Decrypt - Aleopantest V4.0.0

Decrypt Group Policy Preference passwords
"""
import time
import datetime
...
class GPPDecrypt(BaseTool):
    """Decrypt Group Policy Preference passwords"""

    def __init__(self):
        metadata = ToolMetadata(
            name="GPP Password Decrypt",
            category=ToolCategory.ACTIVE_DIRECTORY,
            version="4.0.0",
            author="Aleocrophic Team",
            description="Decrypt Group Policy Preference passwords",
            usage="aleopantest run gpp-decrypt --target <target>",
            requirements=[],
            tags=['ad', 'gpp', 'password'],
            risk_level="LOW",
    ...
    def run(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            result = {
                ...
                "summary": {
                    "risk_level": "LOW",
                    "scan_type": "GPP Password Decrypt",
