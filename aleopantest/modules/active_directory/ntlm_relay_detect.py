"""
NTLM Relay Detector - Aleopantest V4.0.0

Detect NTLM relay attack vectors
"""
import time
import datetime
...
class NTLMRelayDetect(BaseTool):
    """Detect NTLM relay attack vectors"""

    def __init__(self):
        metadata = ToolMetadata(
            name="NTLM Relay Detector",
            category=ToolCategory.ACTIVE_DIRECTORY,
            version="4.0.0",
            author="Aleocrophic Team",
            description="Detect NTLM relay attack vectors",
            usage="aleopantest run ntlm-relay-detect --target <target>",
            requirements=[],
            tags=['ntlm', 'relay', 'detect'],
            risk_level="LOW",
