"""
AD Enumerator - Aleopantest V4.0.0

Active Directory enumeration and user/group discovery
"""
import time
import datetime
...
class ADEnum(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Active Directory enumeration and user/group discovery",
            usage="aleopantest run ad-enum --target <target>",
            requirements=[],
            tags=['ad', 'ldap', 'enum'],
            risk_level="LOW",
