"""
Kerberoast Attack - Aleopantest V4.0.0

Extract and crack Kerberos service tickets
"""
import time
import datetime
...
class Kerberoast(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Extract and crack Kerberos service tickets",
            usage="aleopantest run kerberoast --target <target>",
            requirements=[],
            tags=['ad', 'kerberos', 'crack'],
            risk_level="HIGH",
