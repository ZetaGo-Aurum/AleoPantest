"""
BloodHound Ingestor - Aleopantest V4.0.0

Collect AD data for BloodHound graph analysis
"""
import time
import datetime
...
class BloodhoundIngest(BaseTool):
    """Collect AD data for BloodHound graph analysis"""
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            usage="aleopantest run bloodhound-ingest --target <target>",
            requirements=[],
            tags=['ad', 'bloodhound', 'graph'],
            risk_level="LOW",
