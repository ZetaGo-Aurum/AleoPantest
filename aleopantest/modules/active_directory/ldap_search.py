"""
LDAP Search - Aleopantest V4.0.0

Advanced LDAP search and query tool
"""
import time
import datetime
...
class LDAPSearch(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Advanced LDAP search and query tool",
            usage="aleopantest run ldap-search --target <target>",
            requirements=[],
            tags=['ldap', 'search', 'ad'],
            risk_level="LOW",
