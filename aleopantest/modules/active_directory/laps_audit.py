"""
LAPS Auditor - Aleopantest V4.0.0

Audit Local Administrator Password Solution config
"""
import time
import datetime
...
class LAPSAudit(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Audit Local Administrator Password Solution config",
            usage="aleopantest run laps-audit --target <target>",
            requirements=[],
            tags=['ad', 'laps', 'password'],
            risk_level="LOW",
