"""
AD Delegation Check - Aleopantest V4.0.0

Check for dangerous Kerberos delegations
"""
import time
import datetime
...
class ADDelegation(BaseTool):
    """Check for dangerous Kerberos delegations"""

    def __init__(self):
        metadata = ToolMetadata(
            name="AD Delegation Check",
            category=ToolCategory.ACTIVE_DIRECTORY,
            version="4.0.0",
            author="Aleocrophic Team",
            description="Check for dangerous Kerberos delegations",
            usage="aleopantest run ad-delegation --target <target>",
            requirements=[],
