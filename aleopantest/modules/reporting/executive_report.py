"""
Executive Report - Aleopantest V4.0.0
...
class ExecutiveReport(BaseTool):
    """Generate executive summary reports"""
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            usage="aleopantest run executive-report --target <target>",
            requirements=[],
