"""
Scan Comparison - Aleopantest V4.0.0
...
class ScanCompare(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Compare results between scans",
            usage="aleopantest run scan-compare --target <target>",
            requirements=[],
            tags=['report', 'scan', 'compare'],
            risk_level="LOW",
