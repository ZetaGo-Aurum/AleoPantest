"""
Chart Generator - Aleopantest V4.0.0
...
class ChartGen(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Generate charts from scan results",
            usage="aleopantest run chart-gen --target <target>",
            requirements=[],
            tags=['report', 'chart', 'visualize'],
            risk_level="LOW",
