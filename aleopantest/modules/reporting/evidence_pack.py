"""
Evidence Package - Aleopantest V4.0.0
...
class EvidencePack(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Create evidence packages for audits",
            usage="aleopantest run evidence-pack --target <target>",
            requirements=[],
            tags=['report', 'evidence', 'package'],
            risk_level="LOW",
