"""
SARIF Exporter - Aleopantest V4.0.0
...
class SARIFExport(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Export results in SARIF format",
            usage="aleopantest run sarif-export --target <target>",
            requirements=[],
            tags=['report', 'sarif', 'export'],
            risk_level="LOW",
