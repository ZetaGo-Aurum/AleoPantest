"""
Markdown Report - Aleopantest V4.0.0
...
class MarkdownReport(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            usage="aleopantest run markdown-report --target <target>",
            requirements=[],
            tags=['report', 'markdown', 'doc'],
            risk_level="LOW",
