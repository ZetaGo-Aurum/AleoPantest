"""
Vishing Simulator - Aleopantest V4.0.0

Simulate voice phishing scenarios
"""
import time
import datetime
...
class VishingSim(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Simulate voice phishing scenarios",
            usage="aleopantest run vishing-sim --target <target>",
            requirements=[],
            tags=['social', 'vishing', 'sim'],
            risk_level="HIGH",
