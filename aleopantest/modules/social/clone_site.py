"""
Website Cloner - Aleopantest V4.0.0

Clone websites for authorized phishing tests
"""
import time
import datetime
...
class CloneSite(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Clone websites for authorized phishing tests",
            usage="aleopantest run clone-site --target <target>",
            requirements=[],
            tags=['social', 'clone', 'web'],
            risk_level="HIGH",
