"""
QR Code Phishing - Aleopantest V4.0.0

QR code phishing (quishing) toolkit
"""
import time
import datetime
...
class QRPhish(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="QR code phishing (quishing) toolkit",
            usage="aleopantest run qr-phish --target <target>",
            requirements=[],
            tags=['social', 'qr', 'phish'],
            risk_level="HIGH",
