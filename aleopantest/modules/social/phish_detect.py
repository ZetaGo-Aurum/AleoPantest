"""
Phishing Detector - Aleopantest V4.0.0
...
class PhishDetect(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            usage="aleopantest run phish-detect --target <target>",
            requirements=[],
            tags=['social', 'phish', 'detect'],
            risk_level="LOW",
