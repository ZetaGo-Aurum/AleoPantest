"""
Pretext Generator - Aleopantest V4.0.0
...
class PretextingGen(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Generate social engineering pretexts",
            usage="aleopantest run pretexting-gen --target <target>",
            requirements=[],
            tags=['social', 'pretext', 'gen'],
            risk_level="LOW",
