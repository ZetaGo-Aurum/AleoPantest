"""
Cloud Container Registry - Aleopantest V4.0.0

Audit cloud container registries
"""
import time
import datetime
...
class CloudContainerReg(BaseTool):
    """Audit cloud container registries"""
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Audit cloud container registries",
            usage="aleopantest run cloud-container-reg --target <target>",
            requirements=[],
    ...
    def run(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            result = {
                ...
                "summary": {
                    "risk_level": "LOW",
                    "scan_type": "Cloud Container Registry",
