"""
Azure AD Enumerator - Aleopantest V4.0.0
...
class AzureADEnum(BaseTool):
    """Enumerate Azure Active Directory"""

    def __init__(self):
        metadata = ToolMetadata(
            name="Azure AD Enumerator",
            category=ToolCategory.CLOUD,
            version="4.0.0",
            author="Aleocrophic Team",
            description="Enumerate Azure Active Directory",
            usage="aleopantest run azure-ad-enum --target <target>",
            requirements=[],
            tags=['azure', 'ad', 'enum'],
            risk_level="LOW",
