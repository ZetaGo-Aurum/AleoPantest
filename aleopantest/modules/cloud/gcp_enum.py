"""
GCP Enumerator - Aleopantest V4.0.0

Enumerate Google Cloud Platform resources
"""
import time
import datetime
...
class GCPEnum(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Enumerate Google Cloud Platform resources",
            usage="aleopantest run gcp-enum --target <target>",
            requirements=[],
            tags=['cloud', 'gcp', 'enum'],
            risk_level="LOW",
