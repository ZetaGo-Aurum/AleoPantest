"""
Azure Blob Scanner - Aleopantest V4.0.0

Scan Azure Blob storage for exposure
"""
import time
import datetime
...
class AzureBlobScan(BaseTool):
    """Scan Azure Blob storage for exposure"""

    def __init__(self):
        metadata = ToolMetadata(
            name="Azure Blob Scanner",
            category=ToolCategory.CLOUD,
            version="4.0.0",
            author="Aleocrophic Team",
            description="Scan Azure Blob storage for exposure",
            usage="aleopantest run azure-blob-scan --target <target>",
            requirements=[],
            tags=['azure', 'blob', 'scan'],
            risk_level="LOW",
