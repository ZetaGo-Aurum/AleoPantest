"""
Cloud Cost Auditor - Aleopantest V4.0.0

Audit cloud resources for cost anomalies
"""
import time
import datetime
...
class CloudCostAudit(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Audit cloud resources for cost anomalies",
            usage="aleopantest run cloud-cost-audit --target <target>",
            requirements=[],
            tags=['cloud', 'cost', 'audit'],
            risk_level="LOW",
