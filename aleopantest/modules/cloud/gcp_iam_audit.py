"""
GCP IAM Auditor - Aleopantest V4.0.0

Audit GCP IAM policies and roles
"""
import time
import datetime
...
class GCPIAMAudit(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Audit GCP IAM policies and roles",
            usage="aleopantest run gcp-iam-audit --target <target>",
            requirements=[],
            tags=['gcp', 'iam', 'audit'],
            risk_level="LOW",
