"""
CloudTrail Auditor - Aleopantest V4.0.0

Audit AWS CloudTrail logging config
"""
import time
import datetime
...
class CloudTrailAudit(BaseTool):
    """Audit AWS CloudTrail logging config"""

    def __init__(self):
        metadata = ToolMetadata(
            name="CloudTrail Auditor",
            category=ToolCategory.CLOUD,
            version="4.0.0",
            author="Aleocrophic Team",
            description="Audit AWS CloudTrail logging config",
            usage="aleopantest run cloudtrail-audit --target <target>",
            requirements=[],
