"""
Terraform Scanner - Aleopantest V4.0.0
...
class TerraformScan(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Scan Terraform IaC for misconfigurations",
            usage="aleopantest run terraform-scan --target <target>",
            requirements=[],
            tags=['terraform', 'iac', 'scan'],
            risk_level="LOW",
