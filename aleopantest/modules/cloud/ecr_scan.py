"""
ECR Image Scanner - Aleopantest V4.0.0

Scan AWS ECR container images
"""
import time
import datetime
...
class ECRScan(BaseTool):
    """Scan AWS ECR container images"""

    def __init__(self):
        metadata = ToolMetadata(
            name="ECR Image Scanner",
            category=ToolCategory.CLOUD,
            version="4.0.0",
            author="Aleocrophic Team",
            description="Scan AWS ECR container images",
            usage="aleopantest run ecr-scan --target <target>",
            requirements=[],
            tags=['aws', 'ecr', 'scan'],
            risk_level="LOW",
