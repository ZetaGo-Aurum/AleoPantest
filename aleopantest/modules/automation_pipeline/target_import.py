"""
Target Importer - Aleopantest V4.0.0

Import targets from various formats
"""
import time
import datetime
...
class TargetImport(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Import targets from various formats",
            usage="aleopantest run target-import --target <target>",
            requirements=[],
            tags=['auto', 'target', 'import'],
            risk_level="LOW",
