"""
Scan Resume Tool - Aleopantest V4.0.0
...
class ScanResume(BaseTool):
    """Resume interrupted scans"""

    def __init__(self):
        metadata = ToolMetadata(
            name="Scan Resume Tool",
            category=ToolCategory.AUTOMATION,
            version="4.0.0",
            author="Aleocrophic Team",
            description="Resume interrupted scans",
            usage="aleopantest run scan-resume --target <target>",
            requirements=[],
            tags=['auto', 'resume', 'recover'],
            risk_level="LOW",
