"""
Parallel Scanner - Aleopantest V4.0.0
...
class ParallelScan(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            usage="aleopantest run parallel-scan --target <target>",
            requirements=[],
            tags=['auto', 'parallel', 'scan'],
            risk_level="LOW",
