"""
Workflow Templates - Aleopantest V4.0.0
...
class WorkflowTemplate(BaseTool):
    """Pre-built security workflow templates"""
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Pre-built security workflow templates",
            usage="aleopantest run workflow-template --target <target>",
            requirements=[],
            tags=['auto', 'workflow', 'template'],
            risk_level="LOW",
