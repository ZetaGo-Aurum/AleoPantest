"""
Result Aggregator - Aleopantest V4.0.0
...
class ResultAggregator(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Aggregate results from multiple tools",
            usage="aleopantest run result-aggregator --target <target>",
            requirements=[],
            tags=['auto', 'aggregate', 'results'],
            risk_level="LOW",
