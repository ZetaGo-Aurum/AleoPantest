"""
Webhook Trigger - Aleopantest V4.0.0
...
class WebhookTrigger(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Trigger webhooks on scan completion",
            usage="aleopantest run webhook-trigger --target <target>",
            requirements=[],
            tags=['auto', 'webhook', 'trigger'],
            risk_level="LOW",
