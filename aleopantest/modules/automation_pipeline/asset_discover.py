"""
Asset Discovery - Aleopantest V4.0.0
...
class AssetDiscover(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            usage="aleopantest run asset-discover --target <target>",
            requirements=[],
            tags=['auto', 'asset', 'discover'],
            risk_level="LOW",
