"""
Task Scheduler - Aleopantest V4.0.0
...
class Scheduler(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Schedule periodic security scans",
            usage="aleopantest run scheduler --target <target>",
            requirements=[],
            tags=['auto', 'scheduler', 'cron'],
            risk_level="LOW",
