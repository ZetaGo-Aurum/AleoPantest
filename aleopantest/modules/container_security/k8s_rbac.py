"""
K8s RBAC Auditor - Aleopantest V4.0.0
...
class K8sRBAC(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Audit Kubernetes RBAC permissions",
            usage="aleopantest run k8s-rbac --target <target>",
            requirements=[],
            tags=['k8s', 'rbac', 'audit'],
            risk_level="LOW",
