"""
K8s Pod Security Policy - Aleopantest V4.0.0

Audit Pod Security Policies/Standards
"""
import time
import datetime
...
class K8sPSP(BaseTool):
    """Audit Pod Security Policies/Standards"""

    def __init__(self):
        metadata = ToolMetadata(
            name="K8s Pod Security Policy",
            category=ToolCategory.CONTAINER,
            version="4.0.0",
            author="Aleocrophic Team",
            description="Audit Pod Security Policies/Standards",
            usage="aleopantest run k8s-psp --target <target>",
            requirements=[],
            tags=['k8s', 'psp', 'security'],
            risk_level="LOW",
    ...
    def run(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            result = {
                ...
                "summary": {
                    "risk_level": "LOW",
                    "scan_type": "K8s Pod Security Policy",
