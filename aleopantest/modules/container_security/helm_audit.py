"""
Helm Chart Auditor - Aleopantest V4.0.0

Audit Helm charts for security issues
"""
import time
import datetime
...
class HelmAudit(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Audit Helm charts for security issues",
            usage="aleopantest run helm-audit --target <target>",
            requirements=[],
            tags=['helm', 'k8s', 'audit'],
            risk_level="LOW",
