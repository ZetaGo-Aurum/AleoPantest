"""
Docker Socket Check - Aleopantest V4.0.0
...
class DockerSocket(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Check Docker socket exposure",
            usage="aleopantest run docker-socket --target <target>",
            requirements=[],
            tags=['docker', 'socket', 'security'],
            risk_level="LOW",
