"""
Dockerfile Linter - Aleopantest V4.0.0
...
class DockerfileLint(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Lint Dockerfiles for security best practices",
            usage="aleopantest run dockerfile-lint --target <target>",
            requirements=[],
            tags=['docker', 'dockerfile', 'lint'],
            risk_level="LOW",
