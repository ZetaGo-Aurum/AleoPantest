"""
Container Image Scanner - Aleopantest V4.0.0
...
class ImageScan(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            usage="aleopantest run image-scan --target <target>",
            requirements=[],
            tags=['container', 'image', 'scan'],
            risk_level="LOW",
    ...
    def run(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            result = {
                ...
                "summary": {
                    "risk_level": "LOW",
                    "scan_type": "Container Image Scanner",
