"""
Registry Enumerator - Aleopantest V4.0.0

Enumerate container registries and images
"""
import time
import datetime
...
class RegistryEnum(BaseTool):
    """Enumerate container registries and images"""

    def __init__(self):
        metadata = ToolMetadata(
            name="Registry Enumerator",
            category=ToolCategory.CONTAINER,
            version="4.0.0",
            author="Aleocrophic Team",
            description="Enumerate container registries and images",
            usage="aleopantest run registry-enum --target <target>",
            requirements=[],
            tags=['registry', 'enum', 'docker'],
            risk_level="LOW",
