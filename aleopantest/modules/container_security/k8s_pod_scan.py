"""
K8s Pod Scanner - Aleopantest V4.0.0

Scan Kubernetes pods for vulnerabilities
"""
import time
import datetime
...
class K8sPodScan(BaseTool):
    """Scan Kubernetes pods for vulnerabilities"""

    def __init__(self):
        metadata = ToolMetadata(
            name="K8s Pod Scanner",
            category=ToolCategory.CONTAINER,
            version="4.0.0",
            author="Aleocrophic Team",
            description="Scan Kubernetes pods for vulnerabilities",
            usage="aleopantest run k8s-pod-scan --target <target>",
            requirements=[],
            tags=['k8s', 'pod', 'scan'],
            risk_level="LOW",
