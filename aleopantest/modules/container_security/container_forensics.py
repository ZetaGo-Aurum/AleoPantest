"""
Container Forensics - Aleopantest V4.0.0

Perform forensics on container artifacts
"""
import time
import datetime
...
class ContainerForensics(BaseTool):
    """Perform forensics on container artifacts"""
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Perform forensics on container artifacts",
            usage="aleopantest run container-forensics --target <target>",
            requirements=[],
            tags=['container', 'forensics', 'analysis'],
            risk_level="LOW",
