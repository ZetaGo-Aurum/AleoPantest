"""
Istio Security Check - Aleopantest V4.0.0

Check Istio service mesh security config
"""
import time
import datetime
...
class IstioCheck(BaseTool):
    """Check Istio service mesh security config"""

    def __init__(self):
        metadata = ToolMetadata(
            name="Istio Security Check",
            category=ToolCategory.CONTAINER,
            version="4.0.0",
            author="Aleocrophic Team",
            description="Check Istio service mesh security config",
            usage="aleopantest run istio-check --target <target>",
            requirements=[],
    ...
    def run(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            result = {
                ...
                "summary": {
                    "risk_level": "LOW",
                    "scan_type": "Istio Security Check",
