"""
Threat Intelligence - Aleopantest V4.0.0
...
class ThreatIntel(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Aggregate threat intelligence feeds",
            usage="aleopantest run threat-intel --target <target>",
            requirements=[],
