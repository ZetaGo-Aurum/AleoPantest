"""
Company Recon - Aleopantest V4.0.0

Company reconnaissance and profiling
"""
import time
import datetime
...
class CompanyRecon(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Company reconnaissance and profiling",
            usage="aleopantest run company-recon --target <target>",
            requirements=[],
            tags=['osint', 'company', 'recon'],
            risk_level="LOW",
