"""
LinkedIn Enumerator - Aleopantest V4.0.0

Enumerate LinkedIn profiles/companies
"""
import time
import datetime
...
class LinkedInEnum(BaseTool):
    """Enumerate LinkedIn profiles/companies"""

    def __init__(self):
        metadata = ToolMetadata(
            name="LinkedIn Enumerator",
            category=ToolCategory.OSINT,
            version="4.0.0",
            author="Aleocrophic Team",
            description="Enumerate LinkedIn profiles/companies",
            usage="aleopantest run linkedin-enum --target <target>",
            requirements=[],
            tags=['osint', 'linkedin', 'enum'],
            risk_level="LOW",
