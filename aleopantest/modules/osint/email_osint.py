"""
Email OSINT - Aleopantest V4.0.0

OSINT from email addresses
"""
import time
import datetime
...
class EmailOSINT(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="OSINT from email addresses",
            usage="aleopantest run email-osint --target <target>",
            requirements=[],
            tags=['osint', 'email', 'osint'],
            risk_level="LOW",
