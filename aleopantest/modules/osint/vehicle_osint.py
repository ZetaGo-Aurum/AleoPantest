"""
Vehicle OSINT - Aleopantest V4.0.0

OSINT on vehicle registrations
"""
import time
import datetime
...
class VehicleOSINT(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="OSINT on vehicle registrations",
            usage="aleopantest run vehicle-osint --target <target>",
            requirements=[],
            tags=['osint', 'vehicle', 'osint'],
            risk_level="LOW",
