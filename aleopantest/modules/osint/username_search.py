"""
Username Search - Aleopantest V4.0.0
...
class UsernameSearch(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Search username across 300+ platforms",
            usage="aleopantest run username-search --target <target>",
            requirements=[],
