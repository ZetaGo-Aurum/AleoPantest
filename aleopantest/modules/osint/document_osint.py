"""
Document OSINT - Aleopantest V4.0.0

Extract OSINT from documents
"""
import time
import datetime
...
class DocumentOSINT(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Extract OSINT from documents",
            usage="aleopantest run document-osint --target <target>",
            requirements=[],
            tags=['osint', 'document', 'metadata'],
            risk_level="LOW",
