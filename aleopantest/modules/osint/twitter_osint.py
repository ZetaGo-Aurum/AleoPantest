"""
Twitter/X OSINT - Aleopantest V4.0.0

OSINT on Twitter/X accounts
"""
import time
import datetime
...
class TwitterOSINT(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="OSINT on Twitter/X accounts",
            usage="aleopantest run twitter-osint --target <target>",
            requirements=[],
            tags=['osint', 'twitter', 'social'],
            risk_level="LOW",
