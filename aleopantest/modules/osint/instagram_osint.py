"""
Instagram OSINT - Aleopantest V4.0.0

OSINT on Instagram accounts
"""
import time
import datetime
...
class InstagramOSINT(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="OSINT on Instagram accounts",
            usage="aleopantest run instagram-osint --target <target>",
            requirements=[],
            tags=['osint', 'instagram', 'social'],
            risk_level="LOW",
