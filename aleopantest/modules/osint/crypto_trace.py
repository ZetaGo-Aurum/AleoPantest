"""
Crypto Tracer - Aleopantest V4.0.0
...
class CryptoTrace(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            usage="aleopantest run crypto-trace --target <target>",
            requirements=[],
            tags=['osint', 'crypto', 'blockchain'],
            risk_level="LOW",
