"""
Geolocation OSINT - Aleopantest V4.0.0
...
class GeoOSINT(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Geolocation intelligence from images/data",
            usage="aleopantest run geo-osint --target <target>",
            requirements=[],
            tags=['osint', 'geo', 'location'],
            risk_level="LOW",
