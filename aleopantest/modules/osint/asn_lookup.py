...
class ASNLookup(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Look up ASN information",
            usage="aleopantest run asn-lookup --target <target>",
            requirements=[],
            tags=['osint', 'asn', 'lookup'],
            risk_level="LOW",
