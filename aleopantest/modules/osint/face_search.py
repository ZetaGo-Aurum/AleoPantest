"""
Face Search - Aleopantest V4.0.0

Search faces across the internet
"""
import time
import datetime
...
class FaceSearch(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Search faces across the internet",
            usage="aleopantest run face-search --target <target>",
            requirements=[],
            tags=['osint', 'face', 'search'],
            risk_level="LOW",
