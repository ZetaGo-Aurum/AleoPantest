"""
Phone OSINT - Aleopantest V4.0.0

OSINT from phone numbers
"""
import time
import datetime
...
class PhoneOSINT(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="OSINT from phone numbers",
            usage="aleopantest run phone-osint --target <target>",
            requirements=[],
            tags=['osint', 'phone', 'osint'],
            risk_level="LOW",
