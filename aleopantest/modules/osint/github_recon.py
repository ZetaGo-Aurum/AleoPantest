"""
GitHub Recon - Aleopantest V4.0.0

Recon on GitHub organizations and repos
"""
import time
import datetime
...
class GitHubRecon(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Recon on GitHub organizations and repos",
            usage="aleopantest run github-recon --target <target>",
            requirements=[],
