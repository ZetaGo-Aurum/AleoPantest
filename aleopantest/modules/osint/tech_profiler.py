"""
Technology Profiler - Aleopantest V4.0.0

Profile technology stack of targets
"""
import time
import datetime
...
class TechProfiler(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Profile technology stack of targets",
            usage="aleopantest run tech-profiler --target <target>",
            requirements=[],
            tags=['osint', 'tech', 'profile'],
            risk_level="LOW",
