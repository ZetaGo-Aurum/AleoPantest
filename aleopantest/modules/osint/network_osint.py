"""
Network OSINT - Aleopantest V4.0.0

OSINT from network data (BGP, ASN)
"""
import time
import datetime
...
class NetworkOSINT(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="OSINT from network data (BGP, ASN)",
            usage="aleopantest run network-osint --target <target>",
            requirements=[],
            tags=['osint', 'network', 'bgp'],
            risk_level="LOW",
