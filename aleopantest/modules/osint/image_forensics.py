"""
Image Forensics - Aleopantest V4.0.0
...
class ImageForensics(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Forensic analysis of images",
            usage="aleopantest run image-forensics --target <target>",
            requirements=[],
