"""
Domain Monitor - Aleopantest V4.0.0

Monitor domain changes and registrations
"""
import time
import datetime
...
class DomainMonitor(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Monitor domain changes and registrations",
            usage="aleopantest run domain-monitor --target <target>",
            requirements=[],
            tags=['osint', 'domain', 'monitor'],
            risk_level="LOW",
