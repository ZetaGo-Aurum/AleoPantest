"""
Discord Recon - Aleopantest V4.0.0

Reconnaissance on Discord servers
"""
import time
import datetime
...
class DiscordRecon(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Reconnaissance on Discord servers",
            usage="aleopantest run discord-recon --target <target>",
            requirements=[],
            tags=['osint', 'discord', 'recon'],
            risk_level="LOW",
