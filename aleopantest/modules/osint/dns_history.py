"""
DNS History Lookup - Aleopantest V4.0.0

Look up historical DNS records
"""
import time
import datetime
...
class DNSHistory(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="Look up historical DNS records",
            usage="aleopantest run dns-history --target <target>",
            requirements=[],
            tags=['osint', 'dns', 'history'],
            risk_level="LOW",
