"""
Certificate Search - Aleopantest V4.0.0
...
class CertSearch(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            usage="aleopantest run cert-search --target <target>",
            requirements=[],
            tags=['osint', 'cert', 'transparency'],
            risk_level="LOW",
