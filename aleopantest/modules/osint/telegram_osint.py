"""
Telegram OSINT - Aleopantest V4.0.0

OSINT on Telegram users and groups
"""
import time
import datetime
...
class TelegramOSINT(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            description="OSINT on Telegram users and groups",
            usage="aleopantest run telegram-osint --target <target>",
            requirements=[],
            tags=['osint', 'telegram', 'social'],
            risk_level="LOW",
