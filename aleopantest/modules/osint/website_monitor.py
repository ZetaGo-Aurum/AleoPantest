"""
Website Monitor - Aleopantest V4.0.0
...
class WebsiteMonitor(BaseTool):
    ...
    def __init__(self):
        metadata = ToolMetadata(
            ...
            usage="aleopantest run website-monitor --target <target>",
            requirements=[],
            tags=['osint', 'website', 'monitor'],
            risk_level="LOW",
